...
- (void)viewDidLoad {
    ...
    [self.multiPscope addPermission:[[NotificationsPermission alloc]initWithNotificationCategories:nil]];
    [self.multiPscope addPermission:[[LocationWhileInUsePermission alloc]init]];
